...
public class Board{
	public static int startFrameWidth = 400;
	public static int startFrameHeight = 80;
	public static int ipTextAreaColumns = 10;
	...
	public static String snakeControllerName = "snakecontroller";
}
